        ...
        <div className="w-full flex items-center justify-center flex-col gap-4">
          ...
          <div className="w-full md:w-[80%] flex items-start justify-start gap-4 flex-col h-[500px]">
                      ...
                      >
                        ...
                        <p
                          className={`text-sm p-4 rounded-2xl ${
                            item.userId === authUser._id
                              ? "bg-blue-500 rounded-tr-[0] text-white mt-6"
                              : "bg-gray-200 rounded-tl-[0] mt-6"
                          }`}
                        >
                          {item.desc}
                        </p>
            ...
            <form
              ...
              className="flex items-center w-full md:gap-8 flex-col md:flex-row gap-2"
            >
              <textarea
                name="desc"
                ...
                cols="30"
                rows="10"
                className={`border h-[100px] w-full md:w-[80%] rounded-md resize-none p-2 text-sm font-medium focus:border-[#5C469C] outline-none ${
                  errors.desc && touched.desc ? "border-red-500" : ""
                }`}
              ></textarea>
              <button
                type="submit"
                className="bg-[#5C469C] hover:bg-[#5C469C] text-white w-fit py-3 px-6 text-sm rounded"
              >
                {loading ? (
