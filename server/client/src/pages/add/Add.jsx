        ...
        <div className="flex flex-col w-full gap-4 items-start justify-start">
          ...
          <div className="flex items-start justify-between gap-4 w-full md:flex-row flex-col">
            <div className="w-full md:flex-1 flex items-start justify-start flex-col gap-2">
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                <input
                  ...
                  className={`border w-full h-10 px-3 rounded-md outline-none text-sm border-gray-300 focus:border-[#5C469C]`}
              ...
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                <select
                  ...
                  // onBlur={handleBlur}
                  // value={values.cat}
                  className={`border w-full h-10 px-3 rounded-md outline-none text-sm appearance-none bg-[url(./assets/icons/dropDown.svg)] bg-no-repeat bg-[center_right_1.2rem] cursor-pointer border-gray-300 focus:border-[#5C469C]`}
                >
                  {options.map((item, i) => (
                  ...
                  {singleFile?.type?.startsWith("image/") ? (
                    <div className="flex items-center justify-center gap-2">
                      <img
                        ...
                        alt={singleFile.name}
                        className="w-[100px] h-[100px] rounded-full border-2 border-[#5C469C] object-cover"
                      />
                      <label
                        htmlFor="cover"
                ...
                {files.length === 0 ? (
                  ...
                  <div className="flex items-start  flex-col lg:flex-row justify-start gap-4 w-full">
                    <button
                      ...
                      className="w-[150px] border py-2 rounded-md cursor-pointer hover:bg-[#5C469C] hover:border-[#5C469C] hover:text-white text-base font-medium transition-all duration-300"
                    >
                      {uploading ? (
              ...
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                <textarea
                  ...
                  className={`w-full border h-[136px] rounded-md text-sm text-gray-600 outline-none resize-none border-gray-300 p-3 focus:border-[#5C469C]`}
                  onChange={handleChange}
                  // onBlur={handleBlur}
                  // value={values.desc}
                ></textarea>
              ...
              <button
                ...
                className="w-full bg-[#5C469C] hover:bg-[#5C469C] mt-4 text-white text-base font-semibold h-10 rounded transition-all duration-300 outline-none focus:border-[#5C469C] hidden md:block"
              >
                {loading ? (
                  <div className="flex items-center justify-center">
                    <img src={loader} alt="/" className="w-[30px]" />
            ...
            <div className="w-full md:flex-1 flex items-start justify-start flex-col gap-2">
              ...
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="border w-fit h-10 px-4 rounded bg-[#5C469C] border-[#5C469C] hover:bg-[#5C469C] text-white transition-all duration-300 capitalize"
                  >
                    add
                  </button>
                </form>
                <div className="flex flex-wrap gap-3 w-full">
                  {state?.features?.map((f) => (
                    <div
                      className="flex items-center gap-2 justify-start w-fit bg-[#5C469C] px-2 py-1 rounded-2xl text-white"
                      key={f}
                    >
                      <button
                        onClick={() =>
            ...
            <button
              type="submit"
              onClick={handleSubmit}
              className="w-full bg-/[#5C469C] hover:bg-[#5C469C] mt-4 text-white text-base font-semibold h-10 rounded transition-all duration-300 outline-none focus:border-[#5C469C] md:hidden"
            >
               {loading ? (
                  <div className="flex items-center justify-center">
                    <img src={loader} alt="/" className="w-[30px]" />
