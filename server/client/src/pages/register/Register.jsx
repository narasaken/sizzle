          ...
          >
            <div className="flex items-start justify-start flex-col gap-4 w-full sm:flex-1">
              ...
              <CustomizeInput
                ...
                id="username"
                placeholder="Johndoe"
                className="bg-white  border border-[#C7CBD1] w-full h-[40px] rounded px-4 focus:border-[1.5px] focus:border-[#5C469C] outline-none text-sm"
              />
              <CustomizeInput
                showLabel={false}
                htmlFor="email"
              ...
              <button
                type="submit"
                className="w-full bg-[#5C469C] hover:bg-[#5C469C] cursor-pointer outline-none text-white rounded py-3 transition-all duration-300 mt-4 hidden sm:block"
              >
                {loading ? (
            ...
            <button
              type="submit"
              className="w-full bg-[#5C469C] hover:bg-[#5C469C] cursor-pointer outline-none text-white rounded py-3 transition-all duration-300 mt-4 sm:hidden"
            >
              {loading ? (
                <div className="flex items-center justify-center">
                  <img src={loader} alt="/" className="w-[40px]" />
