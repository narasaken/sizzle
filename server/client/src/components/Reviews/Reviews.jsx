          ...
          >
            <div className="flex items-end w-full justify-between gap-4 md:flex-row flex-col">
              <textarea
                ...
                className={`w-full border px-4 py-2 outline-none rounded-md h-[120px] resize-none focus:border-[#5C469C] ${
              ...
              <div className="flex items-start justify-start flex-col">
                ...
                <select
                  ...
                  onBlur={handleBlur}
                  value={values.star}
                  className={`border outline-none cursor-pointer px-4 rounded focus:border-[#5C469C] text-gray-400  h-10 ${
            ...
            <button
              type="submit"
              className="outline-none bg-[#5C469C] hover:bg-[#5C469C] w-fit px-5 py-2 rounded cursor-pointer text-white transition-all duration-300"
            >
              {loading ? (
