          ...
          <nav className="flex items-center justify-end gap-7 font-medium text-base">
            ...
            {authUser ? (
              ...
              <>
                ...
                <NavLink
                  to="/join"
                  className={`border py-2 px-5 rounded hover:bg-[#5C469C] hover:border-[#5C469C] hover:text-white transition-all duration-300 text-sm font-semibold ${
                    active ? "text-[#5C469C] border-[#5C469C]" : ""
                  }`}
                >
                  Join
                </NavLink>
